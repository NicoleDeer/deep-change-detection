...
class Trainer(object):
    ...
    def __init__(self, net, batch_size=1, verification_batch_size = 4,
    ...
    def _initialize(self, training_iters, output_path, restore, prediction_path):
        ...
        self.norm_gradients_node = tf.Variable(tf.constant(0.0,
            shape=[len(self.net.gradients_node)]), name="norm_gradients")
